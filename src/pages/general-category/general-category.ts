...
@IonicPage()
@Component({
  selector: 'page-general-category',
  templateUrl: 'general-category.html',
})
export class GeneralCategoryPage {
  cards: any;
  news_feeds: any;
  news_feeds_cat_2: any;
  news_feeds_cat_3: any;
  news_feeds_cat_4: any;
  ...
  ionViewDidEnter() {
    ...
    //get live news from the News.org API under the general category
    this.getTopHeadLinesGeneral();
  }
...
*/
  ...
  */
  ...
  getTopHeadLinesGeneral(): void {

    //initiate loader here
    this.news_provider.showLoader("Loading top headlines...");
    // let loadingCtrl = this.loader.create({ content: "Loading top headlines..." });
    // loadingCtrl.present();
    this.news_provider.getTopHeadlinesGeneral()
      .subscribe(data => {
